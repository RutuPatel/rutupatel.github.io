...
const counterblock = [
    ...
    { icon: 'fal fa-smile', count: '7859', title: 'Satisfied Clients', mtclass: "mt-30" },
    { icon: 'fal fa-award', count: '6352', title: 'International Awards', mtclass: "mt-30" },
    { icon: 'fal fa-users-crown', count: '7856', title: 'Expert Team Members', mtclass: "mt-30" }
]
